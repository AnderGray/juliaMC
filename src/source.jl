...
# The generate function will generate a particle bank of length n from a source distribution s. This function could be altered later to also generate secondary neutrons to be added to an existing particle bank
...
@everywhere function generate(s :: Source, mat :: Material_Tendl, n :: Int64, grid :: Array{Float64,1})
    ...
    directions[:,3] = cos.(d_Az)                   # but is debatable if this is faster than looping in Julia (usually not)
